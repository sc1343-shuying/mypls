        ...
        <html lang = "en">
            ...
            <body>
                ...
                <div class="side-nav">
                    ...
                    <ul>
                        <li>
                            <a href="../professor/myPLS.php?id=$url">
                            <span><img  src="../assets/images/logo1.png" alt="icon" /></span> 
                                <span>myPLS</span>
                            </a>
                        </li><li>
                            <a href="../professor/viewAllCourse.php?id=$url">
                            <span><i class="fa fa-bar-chart"></i></span>    
                            <span>All Courses</span>
                            </a>
                        </li>
                        <li>
                            <a href="../professor/professor.php?id=$url">
                            <span><i class="fa fa-bar-chart"></i></span>    
                            <span>My Details</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="../professor/viewCourse.php?id=$url">
                                <span><img src="../assets/images/c.png" alt="icon" /></span>
                                <span>My Course</span>
                            </a>
                        </li>
               ...
               <head>
                ...
                <body>
                    ...
                    <div class="side-nav">
                        ...
                        <ul>
                            <li>
                                <a href="../student/myPLS.php?id=$url">
                                <span><img  src="../assets/images/logo1.png" alt="icon" /></span>
                                    <span>myPLS</span>
                                </a>
                            </li>
                            <li>
                            <a href="../student/viewAllCourse.php?id=$url">
                                <span><i class="fa fa-book"></i></span>
                                <span>All Courses</span>
                            </a>
                            </li>
                            <li>
                                <a href="../student/student.php?id=$url">
                                <span><i class="fa fa-bar-chart"></i></span>
                                <span>My Details</span>
                                </a>
                            </li><li>
                            <a href="../student/viewAllRating.php?id=$url">
                            <span class="fa fa-star"></span>
                            <span>View Feedback</span>
                            </a>
                        </li><li>
                            <a href="../student/addFeedback.php?id=$url">
                                <span><i class="material-icons">border_color</i></span>
                                <span>Add Feedback</span>
                            </a>
                        </li>
